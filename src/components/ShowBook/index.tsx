...
export default function ShowBook() {
    ...
    const getData = async () => {
        const response = await fetch(`${process.env.NEXT_PUBLIC_ENVIRONMENT === 'development' ? 'http://' : 'https://'}${process.env.NEXT_PUBLIC_BASE_URL}/books/${localStorage.getItem('book')}`, {
            method: 'GET',
        });
